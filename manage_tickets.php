...
<head>
    ...
    <style>
        ...
        .desc-box { background-color: #f8fafc; padding: 10px; border-radius: 5px; font-size: 0.9rem; border-left: 3px solid #D4AF37; margin-top: 5px; }

        .btn-resolve { background-color: #198754; color: white; padding: 6px 12px; border: none; border-radius: 5px; cursor: pointer; font-weight: bold; transition: 0.3s; }
        .btn-resolve:hover { background-color: #157347; }
        .text-muted { color: #6b7280; font-size: 0.85rem; font-style: italic; }
...
<div class="management-container">
    ...
    <div class="card">
        ...
        <table>
                            ...
                            <?php if ($t['status'] === 'Pending' || $t['status'] === 'Open'): ?>
                                <form method="POST" style="margin: 0;">
                                    ...
                                    <?php if ($t['request_type'] === 'Suspension Appeal'): ?>
                                        ...
                                        <button type="submit" class="btn-resolve" style="background-color: #D4AF37; color: #0A192F;" onclick="return confirm('Approve this appeal, wipe penalties, and reactivate the student account?');">Approve Appeal</button>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" style="text-align: center; padding: 20px;">No support tickets in the system. Everything is running smoothly!</td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table>
